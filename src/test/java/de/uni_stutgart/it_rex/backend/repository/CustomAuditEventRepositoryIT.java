package de.uni_stutgart.it_rex.backend.repository;

import de.uni_stutgart.it_rex.backend.GatewayApp;

import de.uni_stutgart.it_rex.backend.config.Constants;
import de.uni_stutgart.it_rex.backend.config.TestSecurityConfiguration;
import de.uni_stutgart.it_rex.backend.config.audit.AuditEventConverter;
import de.uni_stutgart.it_rex.backend.domain.PersistentAuditEvent;
...
import static de.uni_stutgart.it_rex.backend.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
