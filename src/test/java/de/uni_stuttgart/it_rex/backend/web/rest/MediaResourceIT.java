package de.uni_stuttgart.it_rex.backend.web.rest;

import de.uni_stuttgart.it_rex.backend.GatewayApp;
import de.uni_stuttgart.it_rex.backend.config.TestSecurityConfiguration;
import de.uni_stuttgart.it_rex.backend.domain.Media;
import de.uni_stuttgart.it_rex.backend.repository.MediaRepository;
import de.uni_stuttgart.it_rex.backend.service.MediaService;
import de.uni_stuttgart.it_rex.backend.service.dto.MediaDTO;
import de.uni_stuttgart.it_rex.backend.service.mapper.MediaMapper;
...
import de.uni_stuttgart.it_rex.backend.domain.enumeration.MIMETYPE;
/**
