...
import de.uni_stuttgart.it_rex.backend.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link de.uni_stuttgart.it_rex.backend.domain.Media}.
 */
@RestController
@RequestMapping("/api")
